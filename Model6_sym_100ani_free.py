...
surfaceParticle11 = airiceSwarm.add_variable ( dataType="int", count=1 )
surfaceParticle11.data[:] = 11
...
while step < maxSteps:
    ...
    if not step%stepsize: # if multiple of ..
        ...
        xdmf_surfswarm11 = airiceSwarm.save('airiceSwarm_' + str(step) + '.h5')
        ...
        xdmf_surfaceParticle11 = surfaceParticle11.save('airiceSwarm_' + str(step) + '.h5')
        ...
        surfaceParticle11.xdmf('airiceSwarm_' + str(step) + '.xdmf', xdmf_surfaceParticle11,
                            "surfaceParticle11", xdmf_surfswarm11, "airiceSwarm", modeltime=step)
